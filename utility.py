...
BRATS_2015_parent_file = "/home/dell/virt-py/FLOYD/dataset/BRATS2015_Training"
...
def save_nuarray_as_mha(image_path, numpy_array):
    sitk.WriteImage(sitk.GetImageFromArray(numpy_array), image_path, True)  # try it with FALSE!!! ; isVector=True then 3d array will be treated as 2d vector else as a 3d image 
